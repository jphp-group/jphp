...
- **пакет** `game`
- **исходники** `php/game/UXSpriteView.php`
...
- `->`[`sprite`](#prop-sprite) : [`UXSprite`](https://github.com/jphp-compiler/jphp/blob/master/exts/jphp-gui-game-ext/api-docs/classes/php/game/UXSprite.ru.md) - _Спрайт._
