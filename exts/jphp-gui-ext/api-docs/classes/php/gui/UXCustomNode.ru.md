...
- **класс** `UXCustomNode` (`php\gui\UXCustomNode`) **унаследован от** [`UXNode`](https://github.com/jphp-compiler/jphp/blob/master/exts/jphp-gui-ext/api-docs/classes/php/gui/UXNode.ru.md)
- **пакет** `gui`
