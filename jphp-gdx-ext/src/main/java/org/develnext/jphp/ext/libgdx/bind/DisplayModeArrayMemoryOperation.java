...
public class DisplayModeArrayMemoryOperation extends MemoryOperation<Graphics.DisplayMode[]> {
    ...
    @Override
    public Graphics.DisplayMode[] convert(Environment env, TraceInfo trace, Memory arg) throws Throwable {
    ...
    @Override
    public Memory unconvert(Environment env, TraceInfo trace, Graphics.DisplayMode[] arg) throws Throwable {
