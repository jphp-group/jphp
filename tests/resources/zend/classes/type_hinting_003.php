...
Recoverable error: Argument 1 passed to Test::f1() must be of the type array, integer given, called in %s on line 35, position %d and defined in %s on line 5, position %d
